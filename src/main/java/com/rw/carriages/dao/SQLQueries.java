...
public interface SQLQueries {
    ...
    public static final String MODEL_BY_TRAIN_SCHEME = "SELECT t2.IS_ACTIVE,t1.ID, t1.CARRIAGE_ID,t1.GRAPHIC_MODEL_WIDTH,t1.GRAPHIC_MODEL_HEIGHT,t1.SEAT_WIDTH,t1.SEAT_HEIGHT,t1.MODEL_SIGN_COORDINATES,t3.MODEL_SEAT_COORDINATES,t2.FIRST_SEAT,t2.LAST_SEAT FROM " +
    ...
    public static final String GRAPHIC_CARRIAGE_SEAT_LAYOUTS = "SELECT * FROM ETICKET.CARRIAGE_SEAT_LAYOUTS WHERE CARRIAGE_ID=:CARRIAGE_ID AND ANCHOR_SERVICE_CLASS LIKE :SERVICE_CLASS AND CARRIAGE_SERVICE_CLASS IN (:CARRIAGE_SERVICE_CLASSES) ORDER BY IS_FULL_PLACES DESC";
    public static final String GRAPHIC_CARRIAGE_SEATS = "SELECT * FROM ETICKET.CARRIAGE_SEATS WHERE CARRIAGE_ID=:CARRIAGE_ID";
